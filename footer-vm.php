...
?>
  <footer id="footer" class="col-xs-12 col-lg-12 source-org vcard copyright" role="contentinfo">
      <div class="col-xs-12 col-sm-12 col-lg-6">
        <div class="ccol-xs-12 col-sm-6 col-lg-7">
          <div class="col-xs-12 direccion">
            <div class="col-xs-3 col-lg-2">
              <a href="https://goo.gl/maps/7MXmJnAmm4s"><span class="fa fa-map-marker pin pin--footer"></span></a>
            </div>
            <div class="col-xs-9 col-lg-10 direccion-texto">
